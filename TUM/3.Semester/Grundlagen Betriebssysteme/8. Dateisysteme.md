...
- Um Effizienz zu wahren wird eine Hashtabelle verwendet
- Die Hashfunktion erhaelt dabei den Namen der Datei als input
...
- Alternativ handelt es sich um Symbolic-Links, die durch eine Datei mit Verweis auf die verlinkte Datei erzeugt werden