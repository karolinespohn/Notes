...
## Kanalkapazitaet
- Die **Kanalkapazitaet** eines Kanals wird durch die **Bandbreite** $B$ und durch die **unterscheidbaren Signalstufen** $M$ begrenzt:
...
- Bitfehler koennen dadurch vermieden werden, denn eine Folge an $1$ern kann sonst den Kndensator laden 
### Modulation
